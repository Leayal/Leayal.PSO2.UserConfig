...
{
    public class PSO2UserConfiguration : PSO2ConfigToken
    {
        ...
        public static PSO2UserConfiguration Parse(string content)
        {
            var result = new PSO2UserConfiguration();
            result.ParseFromString(content);
            return result;
        }

        public static PSO2UserConfiguration FromFile(string filepath)
        {
            var result = new PSO2UserConfiguration();
        ...
        public PSO2UserConfiguration() : base() { }
    }
}

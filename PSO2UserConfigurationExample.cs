...
{
    public class PSO2UserConfigurationExample : IDisposable
    {
        private PSO2UserConfiguration rawdata;

        public PSO2UserConfigurationExample() : this(new PSO2UserConfiguration()) { }

        public PSO2UserConfigurationExample(PSO2UserConfiguration _rawdata)
        {
